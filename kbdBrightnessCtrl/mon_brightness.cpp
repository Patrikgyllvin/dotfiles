...
{
	std::cout << "Usage:\n";
	std::cout << "mon_brightness [-e | -d | -l<level> | -i<percentage> | -r<percentage>]\n";
	std::cout << "  where <level> is a number between 0 and 90.\n";
	std::cout << "  and new level must be between 0 and 90.\n";
}
...
{
	const std::string currentFile = "/sys/class/backlight/acpi_video0/brightness",
